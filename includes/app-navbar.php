    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item <?= ($tab == 0)? 'active' : '' ?>">
          <a class="nav-link" href="/app/checklists/index.php">Checklists</a>
        </li>
        <li class="nav-item <?= ($tab == 1)? 'active' : '' ?>">
          <a class="nav-link" href="/app/users/applicants.php">Applicants</a>
        </li>
        <li class="nav-item <?= ($tab == 2)? 'active' : '' ?>">
          <a class="nav-link" href="/app/users/users.php">Users</a>
        </li>
      </ul>

      <ul class="navbar-nav">
        <li class="nav-item <?= ($tab == 3)? 'active' : '' ?>">
          <a class="nav-link" href="/app/users/user.php"><i class="fas fa-user avatar-sm"></i> You</a>
        </li>
